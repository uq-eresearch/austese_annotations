...
(function() {
  ...
  Annotator = (function(_super) {
    ...
    Annotator.prototype.onAdderClick = function(event) {
      var annotation, cancel, cleanup, position, save, selection,
        _this = this;
      if (event != null) event.preventDefault();
      position = this.adder.position();
      this.adder.hide();
      annotation = this.createAnnotation();
      if (this.adder.data('selection') != null) {
        selection = this.adder.data('selection');
        this.adder.removeData('selection');
