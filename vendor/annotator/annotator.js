...
(function() {
  ...
  Delegator = (function() {
    ...
    Delegator.prototype.addEvent = function(bindTo, event, functionName) {
      ...
      if (typeof bindTo === 'string') {
        if (this.options.bindToDocument != null) {
          this.document.on(event, bindTo, closure);
        } else {
          this.element.on(event, bindTo, closure);
        }
      } else {
    ...
    Delegator.prototype.removeEvents = function() {
      ...
      for (sel in _ref2) {
        functionName = _ref2[sel];
        _ref3 = sel.split(' '), selector = 2 <= _ref3.length ? __slice.call(_ref3, 0, _k = _ref3.length - 1) : (_k = 0, []), event = _ref3[_k++];
        _results.push(this.removeEvent(selector.join(' '), event, functionName));
      }
      return _results;
    };

    Delegator.prototype.removeEvent = function(bindTo, event, functionName) {
      var isBlankSelector;
      isBlankSelector = typeof bindTo === 'string' && bindTo.replace(/\s+/g, '') === '';
      if (isBlankSelector) bindTo = this.element;
      if (typeof bindTo === 'string') {
        if (this.options.bindToDocument != null) {
          return this.document.off(event, bindTo);
        } else {
          return this.element.off(event, bindTo);
        }
      } else {
        if (this.isCustomEvent(event)) {
          return this.unsubscribe(event);
        } else {
          return $(bindTo).unbind(event);
        }
      }
    };
  ...
  Annotator = (function(_super) {
    ...
    Annotator.prototype.selection = null;
    ...
    Annotator.prototype.annotationPlugins = [];

    Annotator.prototype.addAnnotationPlugin = function(plugin) {
      return this.annotationPlugins.push(plugin);
    };
    ...
    function Annotator(element, options) {
      ...
      this.plugins = {};
      appendTo = this.options.bindToDocument != null ? document.body : this.wrapper[0];
      if ($.fn.hoverIntent != null) {
        $(appendTo).hoverIntent(function() {
          return _this.onHighlightMouseover.apply(_this, arguments);
        }, function() {
          return _this.startViewerHideTimer.apply(_this, arguments);
        }, '.annotator-hl');
      } else {
        $(appendTo).on("mouseover", ".annotator-hl", function() {
          return _this.onHighlightMouseover.apply(_this, arguments);
        });
        $(appendTo).on("mouseout", ".annotator-hl", function() {
          return _this.startViewerHideTimer.apply(_this, arguments);
        });
      }
      ...
      this.adder.on("click", "button", function() {
        return _this.onAdderClick.apply(_this, arguments);
      });
      this.adder.on("mousedown", "button", function() {
        return _this.onAdderMousedown.apply(_this, arguments);
      });
      return;
    }
    ...
    Annotator.prototype.destroy = function() {
      ...
      this.adder.remove();
      this.element.removeData('annotator');
    ...
    Annotator.prototype._setupViewer = function() {
      var appendTo,
        _this = this;
      appendTo = this.options.bindToDocument != null ? document.body : this.wrapper;
    ...
    Annotator.prototype._setupEditor = function() {
      ...
      appendTo = this.options.bindToDocument != null ? document.body : this.wrapper;
      this.editor.element.appendTo(appendTo);
      return this;
    };
    ...
    Annotator.prototype.setupAnnotation = function(annotation) {
      var normed, normedRanges, plugin, r, root, _k, _l, _len3, _len4, _len5, _m, _ref2, _ref3;
      _ref2 = this.annotationPlugins;
      for (_k = 0, _len3 = _ref2.length; _k < _len3; _k++) {
        plugin = _ref2[_k];
      ...
      for (_m = 0, _len5 = normedRanges.length; _m < _len5; _m++) {
    ...
    Annotator.prototype.checkForEndSelection = function(event) {
      var appendTo, container, range, _k, _len3, _ref2;
      this.mouseIsDown = false;
      if (this.ignoreMouseup) return;
      if (this.adder.data('selection')) {
        this.selection = this.adder.data('selection');
      } else {
      ...
      if (event && this.selectedRanges.length) {
        return this.adder.css(util.mousePosition(event, appendTo)).show();
      } else {
        this.adder.removeData('selection');
    ...
    Annotator.prototype.onHighlightMouseover = function(event) {
      ...
      appendTo = this.options.bindToDocument != null ? document.body : this.wrapper[0];
      return this.showViewer($.makeArray(annotations), util.mousePosition(event, appendTo));
    };
    ...
    Annotator.prototype.onAdderClick = function(event) {
      ...
      if (this.adder.data('relativeSelection') != null) {
        annotation.relativeSelection = this.adder.data('relativeSelection');
        this.adder.removeData('relativeSelection');
      }
      ...
      cancel = function() {
        ...
        if (annotation.removeMarkers != null) return annotation.removeMarkers();
      };
      cleanup = function() {
  ...
  jQuery.fn.removeAnnotator = function() {
    this.each(function() {
      var instance;
      instance = $.data(this, 'annotator');
      if (instance) {
        instance.destroy();
        return $.removeData(this, 'annotator');
      }
    });
    return this;
  };
