...
(function() {
  ...
  Annotator.Plugin.Image = (function(_super) {
    ...
    Image.prototype._onWindowResized = function() {
      ...
      return jQuery(document).find('span.annotator-hl').map(function() {
        ...
        if (annotation) {
          return annoPlugin.updateMarkerPosition(annotation);
        }
      });
    };
    ...
    Image.prototype._onSelectStart = function(image, selection) {
      var _ref1;
      if ((_ref1 = this.adder) != null) {
        _ref1.removeData('selection');
      }
  ...
  Annotator.ImageAnnotation = (function(_super) {
    ...
    function ImageAnnotation() {
      _ref1 = ImageAnnotation.__super__.constructor.apply(this, arguments);
      return _ref1;
    }

    ImageAnnotation.prototype.hideMarker = function() {
      var _ref2;
      return (_ref2 = this.marker) != null ? _ref2.hide() : void 0;
    };
...
//@ sourceMappingURL=annotator.image.map