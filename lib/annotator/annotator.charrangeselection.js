  ...
  Annotator.Plugin.CharRangeSelection = (function(_super) {
    ...
    CharRangeSelection.prototype.annotationsLoaded = function(annotations) {
      ...
      for (_i = 0, _len = annotations.length; _i < _len; _i++) {
        ...
        if ((!(annotation.ranges != null) || annotation.ranges.length === 0) && (annotation.startOffset != null)) {
    ...
    CharRangeSelection.prototype._loadAnnotation = function(annotation) {
      ...
      if ((annotation.quote != null) && annotation.quote !== selectedText) {
        console.log("PANIC: annotation is attached incorrectly. Should be: '" + annotation.quote + "'. But is: '" + selectedText + "'", {
          range: range,
