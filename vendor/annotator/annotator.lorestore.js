...
(function() {
  ...
  Annotator.Plugin.LoreStore = (function(_super) {
    ...
    LoreStore.prototype.mapAnnotations = function(data) {
      var anno, annos, annotations, body, creator, id, image, processSelector, selectiondata, selector, selectors, target, targetsel, tempanno, textQuoteSelector, _i, _j, _len, _len1;
      if (data == null) {
        data = {};
      }
      annotations = [];
...
//@ sourceMappingURL=annotator.lorestore.map