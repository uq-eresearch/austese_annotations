...
Annotator = (function(_super) {
  ...
  function Annotator(element, options) {
    ...
    if ($.fn.hoverIntent != null) {
      ...
      $(this.element).on("mouseover", ".annotator-hl", function() {
        return _this.onHighlightMouseover.apply(_this, arguments);
      });
      $(this.element).on("mouseout", ".annotator-hl", function() {
        return _this.startViewerHideTimer.apply(_this, arguments);
      });
    }
  ...
  Annotator.prototype.destroy = function() {
    ...
    return Annotator._instances.push(this);
  };
  ...
  Annotator.prototype.setupAnnotation = function(annotation) {
    var e, normed, normedRanges, plugin, r, root, _i, _j, _k, _len, _len1, _len2, _ref, _ref1;
    _ref = this.annotationPlugins;
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      plugin = _ref[_i];
  ...
  Annotator.prototype.hideAnnotation = function(annotation) {
    var child, h, _i, _len, _ref, _results;
  ...
  Annotator.prototype.checkForEndSelection = function(event) {
    var appendTo, container, range, _i, _len, _ref;
  ...
  Annotator.prototype.onHighlightMouseover = function(event) {
    var annotations, appendTo, _ref;
    this.clearViewerHideTimer();
    if (this.mouseIsDown) {
      return false;
    }
    if (this.viewer.isShown() && ($.fn.hoverIntent == null)) {
      return false;
    }
    if (this.editor.isShown() && (_ref = event.target, __indexOf.call(this.editor.annotation.highlights, _ref) >= 0)) {
      return false;
    }
