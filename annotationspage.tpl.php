...
<link rel='stylesheet' href='/<?php print drupal_get_path('module', 'annotations'); ?>//lib/annotator/lib/vendor/jquery.imgareaselect-0.9.10/css/imgareaselect-default.css'>
...
<div data-id="fish" style="width:65%">
<img src="/<?php print drupal_get_path('module', 'annotations'); ?>/U1933_UBC-007.jpg">
</div>
<div data-id="flamboy">
<img src="/<?php print drupal_get_path('module', 'annotations'); ?>/1HW_Q2_A3v.png">
</div>
<script>
