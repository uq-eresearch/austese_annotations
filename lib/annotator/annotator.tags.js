...
(function() {
  ...
  Annotator.Plugin.Tags = (function(_super) {
    ...
    Tags.prototype.pluginInit = function() {
      ...
      return this.input = jQuery(this.field).find(':input');
    };
    ...
    Tags.prototype.updateViewer = function(field, annotation) {
      field = jQuery(field);
      if (annotation.tags && jQuery.isArray(annotation.tags) && annotation.tags.length) {
        return field.addClass('annotator-tags').html(function() {
          var string;
          return string = jQuery.map(annotation.tags, function(tag) {
