...
(function() {
  ...
  Annotator.Plugin.LoreStore = (function(_super) {
    ...
    LoreStore.prototype._onLoadAnnotations = function(data) {
      var anno, annos, body, creator, id, image, processSelector, selectiondata, selector, selectors, target, targetsel, tempanno, textQuoteSelector, _i, _j, _len, _len2;
      if (data == null) data = [];
      this.loads--;
      ...
      for (_i = 0, _len = annos.length; _i < _len; _i++) {
        ...
        if (anno.annotatedBy) {
          ...
          if (creator) tempanno.creator = creator.name;
        }
