...
(function() {
  ...
  Annotator.Plugin.Tags = (function(_super) {
    ...
    Tags.prototype.pluginInit = function() {
      ...
      return this.input = Annotator.$(this.field).find(':input');
    };
    ...
    Tags.prototype.updateViewer = function(field, annotation) {
      ...
      if (annotation.tags && Annotator.$.isArray(annotation.tags) && annotation.tags.length) {
        return field.addClass('annotator-tags').html(function() {
          var string;
          return string = Annotator.$.map(annotation.tags, function(tag) {
